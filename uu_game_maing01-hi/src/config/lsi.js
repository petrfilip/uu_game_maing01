const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuGame",
      en: "About application uuGame",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuGame.",
      en: "You can buy your own uuGame.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuGame.",
      en: "You don't have rights to initialize this uuGame.",
    },
  },
