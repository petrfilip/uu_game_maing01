...
function readPackage(pkg) {
  ...
  if (pkg.name === projectPkg.name) { // hide uuAppg01Devkit dependency from package.json of script library (needed because of jest.config.js requires configuration from uu_appg01_devkit module).
